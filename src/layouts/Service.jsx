  ...
  return (
    <section className=' pb-[103px]'>
        <Container>
            ...
            <SubHeading text="There are many variations of passages of Lorem Ipsum available, but themajority  have suffered alteration in some form." className='text-center px-3 md:px-0 md:w-[590px] mx-auto pt-5 leading-[26px]'/>
